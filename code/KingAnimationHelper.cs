...
namespace Sandbox
{
	...
	public class KingAnimationHelper : BaseNetworkable
	{
		...
		public int SitState
		{
			get => Owner.GetAnimParameterInt( "sit" );
			set => Owner.SetAnimParameter( "sit", value );
		}

		public float SitHeightOffset
		{
			get => Owner.GetAnimParameterFloat( "sit_offset_height" );
			set => Owner.SetAnimParameter( "sit_offset_height", value );
		}

		public float SitPose
		{
			get => Owner.GetAnimParameterFloat( "sit_pose" );
			set => Owner.SetAnimParameter( "sit_pose", value );
		}
